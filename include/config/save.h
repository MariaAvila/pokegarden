...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE    // Frees up ramScript (1104 bytes). Not used in Pokémon Aegis.
#define FREE_MATCH_CALL                     FALSE   // Frees up match call and rematch / VS Seeker data. (104 bytes).
#define FREE_UNION_ROOM_CHAT                TRUE    // Frees up union room chat (212 bytes). Not used in Pokémon Aegis.
#define FREE_ENIGMA_BERRY                   TRUE    // Frees up E-Reader Enigma Berry data (52 bytes). Not used in Pokémon Aegis.
#define FREE_LINK_BATTLE_RECORDS            FALSE   // Frees up link battle record data (88 bytes).
#define FREE_MYSTERY_GIFT                   TRUE    // Frees up Mystery Gift data (876 bytes). Not used in Pokémon Aegis.
